...
class AdminIT extends StatefulWidget {
  const AdminIT ({Key? key}) : super(key: key);

  @override
  State<AdminIT > createState() => _AdminITState();
  
}
class _AdminITState extends State<AdminIT> {
  
   @override
  Widget build(BuildContext context) {
    return Center(
      child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        stream: FirebaseFirestore.instance.collection('ItRequests').snapshots(),
