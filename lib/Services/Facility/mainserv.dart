...
class MainService extends StatelessWidget {
   MainService({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(  backgroundColor: const Color.fromARGB(255, 201, 216, 197),
      ...
      appBar: AppBar(title: const Text("Maintenance Request"), centerTitle: true,
           leading: Image.asset(
      ...
      child: Column(
            ...
            children: <Widget>[
              ...
              const CircleAvatar(
                radius: 50,
                backgroundImage: NetworkImage('https://iili.io/JHviZpR.png',
),
              ),
              DropdownButtons(
                collectionName: 'MRequest',
              ...
              ElevatedButton.icon(style: ElevatedButton.styleFrom(
                ...
                onPressed: () {
                  ...
                  CollectionReference collRef =
                      FirebaseFirestore.instance.collection('MainRequests');
                  collRef.add({
...
class _DropdownButtonsState extends State<DropdownButtons> {
  ...
  Future<void> fetchDropdownItems() async {
    dropdownItems = await MainService().fetchCollection(widget.collectionName);
    setState(() {});
  }
