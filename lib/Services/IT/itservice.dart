...
class ItService extends StatelessWidget {
   ItService({Key? key}) : super(key: key);
...
Future<List<String>> fetchCollection(String collectionName) async {
  ...
  Widget build(BuildContext context) {
    return Scaffold(  backgroundColor: const Color.fromARGB(255, 201, 216, 197),
      ...
      appBar: AppBar(title: const Text("IT Service Request"), centerTitle: true,
      leading: Image.asset(
      ...
      child: Column(
            ...
            children: <Widget>[
              ...
              const CircleAvatar(
                radius: 50,
                backgroundImage: NetworkImage('https://iili.io/JHviQkv.png',
),
              ),
              DropdownButtons(
                collectionName: 'IRequest',
